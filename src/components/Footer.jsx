    ...
    <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col md:flex-row justify-between w-full md:w-auto">
            {[
                ...
                <div key={index} className="text-center md:text-left mb-6 md:mb-0 md:mr-10">
                    ...
                    <ul>
                        {section.links.map((link, i) => (
                            <li key={i}>
                                <a
                                    href={
                                        restaurant?.socialMedia?.[link.toLowerCase()] ||
            ...
            <div className="text-center md:text-left">
                ...
                <div className="mt-2">
                    <a href="/terms" className="text-gray-600 mr-4">
                        Terms & Conditions
                    </a>
